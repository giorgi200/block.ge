          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <ul class="list-unstyled user-profile-nav">
                <li><a href=""><i class="icon ion-ios-person"></i>სურათის შეცვლა</a></li>
                <li><a href=""><i class="icon ion-key"></i>პაროლის შეცვლა</a></li>
                <li><a href=""><i class="icon ion-power"></i> გასვლა</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
